    ...
    <div class="container">
        <div class="row" id="top" align="center">
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark col-12 h-100">
                <a class="navbar-brand">Editor de Clientes</a>
					...
					<p>
						...
						<form method="post" action="controller/ControllerCadastro.php?funcao=editar&id=<?php echo $resultado[0]['id']; ?>" id="form" name="form">
							...
							<div class="form-group">
								...
								<input type="date" class="form-control" required name="txtData" id="txtData" value="<?php echo $resultado[0]['data_contato']; ?>">
							</div>
							<div class="form-group">
								<label for="exampleFormControlTextarea1">Observação</label>
								<textarea class="form-control" name="txtObs" id="txtObs" rows="3"><?php echo $resultado[0]['obs']; ?></textarea>
							</div>
